    ...
    <aside className={`sidebar no-print ${mobileOpen ? 'open' : ''}`}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, padding: 12 }}>
        <button
          className="btn"
          onClick={() => {
            dispatch({ type: 'SET_VIEW', payload: 'ledger' })
            setMobileOpen(false)
          }}
          style={{
              ...
              >
                <div
                  style={{
                    ...
                    fontWeight: 800,
                    fontSize: 14,
                    background: stats.pending > 0 ? 'rgba(217,59,58,0.15)' : 'rgba(47,107,18,0.15)',
      ...
      {logoutAsk && (
        <div className="modal-backdrop" style={{ zIndex: 300 }}>
          <div className="card modal-card" style={{ width: 'min(340px, 100%)', padding: 22 }}>
            <h3 style={{ margin: '0 0 8px', fontWeight: 800, color: 'var(--text)' }}>Logout?</h3>
